...
class TMidasOnline : public TObject, public VirtualOdb
{
public:
...
public:
  ...
  unsigned char odbReadByte(const char*name, int index = 0, unsigned char defaultValue = 0);
